...
class Data {
    ...
    public String score() { 
        ...
        String result = "%d:%d:%d:%d";
        result = String.format(result, white, whiteKings, black, blackKings);
        return result;
    }

    public int pieceAt(int row, int col) { // method that returns piece location
    ...
    public movesMade[] getLegalMoves(int player) { // determines legal moves for player
        ...
        ArrayList<movesMade> moves = new ArrayList<>(); // creates a new Array to story legal moves
